...
class OthelloNNet(nn.Module):
    def __init__(self, game, args):
        ...
        n1 = 1024
        self.fc1 = nn.Linear((self.board_x)*(self.board_y), n1)
        self.fc_bn1 = nn.BatchNorm1d(n1)

        n2 = 512
        self.fc2 = nn.Linear(n1, n2)
        self.fc_bn2 = nn.BatchNorm1d(n2)

        self.fc3 = nn.Linear(n2, self.action_size)
    ...
    def forward(self, s):
        ...
        s = F.dropout(F.relu(self.fc_bn1(self.fc1(s))), p=self.args.dropout, training=self.training)  # batch_size x n1
        s = F.dropout(F.relu(self.fc_bn2(self.fc2(s))), p=self.args.dropout, training=self.training)  # batch_size x n2
